<div class="container mx-auto py-16 px-8">
    <div class="mb-4">
        <input type="text" wire:model.lazy="search" placeholder="Search for Products" class="form-control">
    </div>
    <table class="table table-striped">
        ...
        @foreach($products as $product)
            <tr>
                ...
                <td class="py-2 px-3 border-b"><img class="img img-thumbnail" style="max-width:100px; max-height:100px;" src="{{$product->image}}"></td>
